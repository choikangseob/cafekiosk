...
public class OrderStatisticsServiceTest {
    ...
    public void sendOrderStatisticsMail (){
        ...
        Order order1 = createPaymentCompletedOrder(products, LocalDateTime.of(2024,12,2,23,59,59));
        Order order2 = createPaymentCompletedOrder(products, now);
        Order order3 = createPaymentCompletedOrder(products, LocalDateTime.of(2024,12,3,23,59,59));
        Order order4 = createPaymentCompletedOrder(products, LocalDateTime.of(2024,12,4,0,0));
        // when
